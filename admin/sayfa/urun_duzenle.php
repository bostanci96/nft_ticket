	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Bilet Yönetimi</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item"><a href="index.php?sayfa=urunler">Etkinlikler</a>
							</li>
							<li class="breadcrumb-item active"><a href="javascript:void(0);">Bilet Düzenle</a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">   <p><b><?php echo $catRow["urun_adi"];?> </b> Adlı Etklinlik Bileti Düzenleniyor</p> </h4>
						</div>
								...
								<form role="form" id="forms"class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=urun_edit"  enctype="multipart/form-data">
									...
									<div class="form-body">
														...
														<div class="form-group row">
															...
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	...
																	<input type="text" id="first-name" class="form-control" name="urun_icerik" value="<?php echo $salonadi["kategori_adi"];?>">
										...
										<div class="col-12">
											<div class="form-group row">
												<div class="col-md-2">
													<span>Etkinlik Bilet Örneği <br><small>(3508x2480)</small></span>
												</div>
												<div class="col-md-10">
													<fieldset class="form-group">                                                    
														<div class="custom-file">
															<input type="file" class="custom-file-input" id="inputGroupFile022" title="Resim seç !" name="dosya22[]" id="dosya22[]" multiple>
															<label class="custom-file-label" for="inputGroupFile022">Etkinlik Bilet Örneği Seçiniz</label>
														</div>
													</fieldset>
												</div>
											</div>
	...
	$(document).ready(function(event) {
		...
		$('#forms').ajaxForm({
			...
			uploadProgress: function(event, position, total, percentComplete) {
				swal({
					title: "Yükleniyor",
					text : "Etkinlik Güncelleniyor. Lütfen Bekleyiniz",
					type : "info",
			...
			success: function(data) {
				if(data=="bos-deger"){
					...
					sweetAlert({
						title	: "Başarılı",
						text 	: "Etkinlik Başarılı Bir Şekilde Güncellendi",
						type	: "success"
					},
					function(){
						window.location.reload(true);
