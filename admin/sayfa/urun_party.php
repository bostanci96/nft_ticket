	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
          <h2 class="content-header-title float-left mb-0"><?php echo $catRow["party_title"]; ?> Adlı Bilet Yönetimi</h2>
              ...
              foreach ($parties as $item) { ?>
                  <tr>
                     <td> </td>
                      ...
                      <td><a href="<?= $ayar['site_url'] . NFTBILET . $item['qr_random'] ."/" . $item['qr_product'] ?>" target="_blank">Tıkla</a></td>
