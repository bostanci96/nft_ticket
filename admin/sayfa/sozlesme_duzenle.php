	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Sözleşme İşlemleri</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
						</li>
						<li class="breadcrumb-item"><a href="index.php?sayfa=sozlesme_dogrulama">Sözleşme Doğrulama</a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0);">Sözleşme Doğrulama </a>
				</li>
			</ol>
		</div>
	</div>
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">   <p><b><?php echo $uyeRow["uye_ad"]." ".$uyeRow["uye_soyad"];?></b> adlı Kullanıcı Sözleşme Kontrol..</p> </h4>
			</div>
			<div class="card-content">
				<div class="card-body">
					<form role="form"  id="forms" method="POST" action="ajax.php?p=uye_sozlesme_onay">
						...
						<div class="row">
							...
							<div class="col-12">
								<div class="form-group row">
									<div class="col-md-3">
										<span>Islak İmzalı Sözleşme</span>
									</div>
									<div class="col-md-9">
  									<a href="<?php echo URL; ?>images/sozlezme_pdf/big/<?php echo $uyeRow["uye_sozlezme_pdf"]; ?>" target="_blank"><img  src="<?php echo URL; ?>images/sozlezme_pdf/big/<?php echo $uyeRow["uye_sozlezme_pdf"]; ?>" class="img-fluid"></a>
									</div>
								</div>
							</div>
		...
		<div class="col-6">
								<div class="form-group row">
									...
									<div class="col-md-9">
										<fieldset class="position-relative has-icon-left">
											<input type="text" class="form-control" name="uye_soz_onay" >
											<div class="form-control-position">
												<i class="feather icon-type"></i>
											</div>
										</fieldset>
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<fieldset class="position-relative has-icon-left">
											<input type="text" class="form-control" name="uye_soz_bitis" >
											<div class="form-control-position">
												<i class="feather icon-type"></i>
											</div>
										</fieldset>
						...
						<div class="col-md-4">
							<div id="id_box"></div>
							<button type="submit" name="yenideniste" value="true" class="btn btn-primary btn-lg mr-1 mb-1"  <?php if($uyeRow["uye_kyc_mod"]==6){ echo "disabled"; }?>><?php if($uyeRow["uye_kyc_mod"]==6){ echo "PDF Yeniden İstendi"; }else{ echo "PDF Yeniden İste";} ?></button>
							
						</div>
						<div class="col-md-8">
							<div id="id_box"></div>
							<button type="submit" name="isletmeonay" value="true" class="btn btn-primary btn-lg mr-1 mb-1"  <?php if($uyeRow["uye_kayıt_rutbe"]==7){ echo "disabled"; }?>><?php if($uyeRow["uye_kayıt_rutbe"]==7){ echo "Sözleşme Onaylandı"; }else{ echo "Sözleşmeyi Onayla";} ?></button>
		...
		$('#forms').ajaxForm({
			success: function(data) {
				if(data=="bos-deger"){
					...
					sweetAlert({
								title	: "Başarılı",
								text 	: "Sözleşme Başarılı bir şekilde onaylandı !",
								type	: "success"
					},
					function(){
					...
					sweetAlert({
								title	: "Başarılı",
								text 	: "Sözleşme Başarılı bir şekilde onaylandı ! Mail Gönderilemedi !!",
								type	: "info"
					},
					function(){
						window.location.reload(true);
