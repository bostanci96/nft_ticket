...
<div class="row match-height">
					...
					<form role="form"  id="forms" method="POST" action="ajax.php?p=uye_sertifika_onay">
						...
						<div class="row">
							...
							<div class="col-12">
								<div class="form-group row">
									<div class="col-md-2">
										<span>Etkinlik Salon Adı</span>
									</div>
									<div class="col-md-10">
										<fieldset class="position-relative has-icon-left">
											<input type="text" class="form-control" value="<?php echo $salonadi["kategori_adi"];?>" placeholder="" >
											<input type="hidden" class="form-control" name="sertifi_adet" value="<?php echo $uyeRow["sertifi_adet"];?>" placeholder="" >
											<div class="form-control-position">
												<i class="feather icon-type"></i>
											</div>
										</fieldset>
							...
							<div class="col-12">
								<div class="form-group row">
									<div class="col-md-2">
										<span>QR Okuyucu Durumu</span>
									</div>
									<div class="col-md-10">
										<fieldset class="position-relative has-icon-left">
											<input type="text" class="form-control" name="qr_okuyucu" value="<?php if($uyeRow["qr_okuyucu"] == "on"){echo"QR Okuyucu Kullanılacak";}else{echo "QR Okuyucu Kullanılmayacak";}?>" placeholder="" >
											<div class="form-control-position">
												<i class="feather icon-type"></i>
											</div>
										</fieldset>
    ...
    <img src="<?php echo URL; ?>images/sertifika_onaybelgeleri/big/<?php echo $uyeRow["sertifi_belge"]; ?>" width="100%" height="500px">
    ...
    <img src="<?php echo URL; ?>images/sertifika_onaybelgeleri_2/big/<?php echo $uyeRow["sertifi_belge_2"]; ?>" width="100%" height="500px">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
  									<a href="<?php echo URL; ?>images/sertifika_onaybelgeleri_3/big/<?php echo $uyeRow["etkinlik_bilet_sozlesme"]; ?>" target="_blank">
    <img src="<?php echo URL; ?>images/sertifika_onaybelgeleri_3/big/<?php echo $uyeRow["etkinlik_bilet_sozlesme"]; ?>" width="100%" height="500px">
