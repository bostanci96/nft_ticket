...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
	...
	<div class="main-menu-content">
		...
		<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Menu Levels">Sayfalar</span></a>
				...
				<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Menu Levels">Blog</span></a>
				<ul class="menu-content">
...
<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Menu Levels">Database</span></a>
				<ul class="menu-content">
...
<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Menu Levels">Faturalar</span></a>
				<ul class="menu-content">
					<li class='<?php classActive('komisyon_fatura_list',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=komisyon_fatura_list"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Komisyon Faturaları</span></a>
					</li>

					<li  class='<?php classActive('komisyon_fatura_ekle',@$_GET['sayfa']);?>'><a href="index.php?sayfa=komisyon_fatura_ekle"><i class="feather icon-plus-square"></i><span class="menu-item" data-i18n="Second Level">K. Fatura Ekle</span></a>
					</li>

					<li class='<?php classActive('ziyaretci_fatura_list',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=ziyaretci_fatura_list"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Ziyaretçi Faturaları</span></a>
					</li>
				</ul>
			</li>
<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Menu Levels">Mekanlar</span></a>
				<ul class="menu-content">
					<li class='<?php classActive('mekanlar',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=mekanlar"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Mekanlar</span></a>
					</li>
						<li class='<?php classActive('mekan_ekle',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=mekan_ekle"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Mekan Ekle</span></a>
					</li>
					<li class='<?php classActive('mekan_koltuklari',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=mekan_koltuklari"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Koltuklar</span></a>
					</li>
						<li class='<?php classActive('mekan_koltuk_ekle',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=mekan_koltuk_ekle"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Koltuk Ekle</span></a>
					</li>
...
<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Menu Levels">Kategoriler</span></a>
			...
			<li class='<?php classActive('urunler',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=urunler"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Tüm Etkinlikler</span></a>
					</li>
		<!--	<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-clipboard"></i><span class="menu-title" data-i18n="Menu Levels">Sertifikalar</span></a>
				<ul class="menu-content">
					...
					<li class='<?php classActive('kyc_dogrulama',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=kyc_dogrulama"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">KYC Doğrulama</span></a>
					</li>
					<li class='<?php classActive('isletme_dogrulama',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=isletme_dogrulama"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">İşletme Doğrulama</span></a>
					</li>
<li class='<?php classActive('sozlesme_dogrulama',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=sozlesme_dogrulama"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Sözleşme Doğrulama</span></a>
					</li>
					<li class='<?php classActive('sertifika_dogrulama',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=sertifika_dogrulama"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Etkinlik Doğrulama</span></a>
					</li>
<li class='<?php classActive('sertifika_transfer',@$_GET['sayfa']);?>' ><a href="index.php?sayfa=sertifika_transfer"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Etkinlik Transfer</span></a>
					</li>
