...
<ul class="nav navbar-nav align-items-center ms-auto">
    ...
    <li class="nav-item dropdown dropdown-user">
        <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"><?php echo $uyeRow["uye_firmaunvan"]; ?> - <?php if (!$_SESSION['uye_rutbexxxxx']) { ?><?php echo $uyeRow["uye_ad"].' '.$uyeRow["uye_soyad"]; ?><?php  }else{ echo $_SESSION['uye_adsoyad']; } ?></span><span class="user-status"><?php echo rutbekont($uyeRow["uye_rutbe"]); ?></span></div>
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
            <?php if (!$_SESSION['uye_rutbexxxxx']) { ?>
            

            <a class="dropdown-item" href="<?php echo URL; ?>profile/"><i class="me-50" data-feather="user"></i> <?php echo $bloklar["profil_setings_two"]; ?></a>
                <a class="dropdown-item" href="<?php echo URL; ?>uyeler/"><i class="me-50" data-feather="users"></i> <?php echo $bloklar["profil_setings_uyeler"]; ?></a>
                           <?php  } ?>
