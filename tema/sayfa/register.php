                ...
                <div class="content-body">
                    <div class="auth-wrapper auth-cover">
                        <div class="auth-inner row m-0">
                            ...
                            <div class="d-none d-lg-flex col-lg-5 align-items-center p-5" style="background-image: url(<?php echo URL; ?>images/arkaplan.jpg); background-repeat: no-repeat; background-size: cover; background-position: center;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="date" class="form-control date-mask" name="date" placeholder="DD-MM-YYYY" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    <div class="d-flex justify-content-between">
                                                        <label class="form-label" for="register_label_onbes"><?=$bloklar["register_label_onbes"]?></label>
                                                    </div>
                                                    <input class="form-check-input" type="radio"  name="tip"  id="register_label_onuc" value="1" />
                                                    <label class="form-check-label"for="register_label_onuc"><?=$bloklar["register_label_onuc"]?></label>
                                                    &ensp;
                                                    <input class="form-check-input" type="radio"  name="tip"  id="register_label_ondort" value="2" />
                                                    <label class="form-check-label" for="register_label_ondort"><?=$bloklar["register_label_ondort"]?></label>
                                                </div>
                                            </div>
                                           <!-- <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input class="form-check-input" type="radio"  name="sitelang"  id="register_label_onbir" value="11" />
                                                    <label class="form-check-label"for="register_label_onbir"><?=$bloklar["register_label_onbir"]?></label>
                                                    &ensp;
                                                    <input class="form-check-input" type="radio"  name="sitelang"  id="register_label_oniki" value="22" />
