                    ...
                    <div class="col-12">
                     ...
                     <li class="nav-item">
                        ...
                        <?php endif; ?>
                               <!-- security -->
                            <li class="nav-item ">
                                <a class="nav-link <?php classActive('password-edit',@$par[0]);?>" href="<?php echo URL; ?>password-edit/">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body py-2 my-25">
                                ...
                                <!-- form -->
                                <form class="validate-form pt-50"  id="forms" method="POST" action="<?php echo TEMA_URL; ?>ajax.php?p=passwordupdate"  enctype="multipart/form-data">
                                    <div class="row">
                                       <input type="hidden" name="uyeid" value="<?php echo $uyeRow["uye_id"]; ?>">
                                        <div class="col-md-6">
                                                ...
                                                <div class="mb-1">
                                                    <div class="d-flex justify-content-between">
                                                        <label class="form-label" for="register-password-two"><?=$bloklar["sifre_resetleme_tree"]?></label>
                                                    </div>
                                                    <div class="input-group input-group-merge form-password-toggle">
                                                        <input class="form-control form-control-merge" id="register-password-two" type="password" name="password_two" placeholder="<?=$bloklar["register_input_nine"]?>" aria-describedby="login-password" tabindex="2" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                           
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary mt-1 me-1"><?=$bloklar["sifre_resetleme_two"]?></button>
                                        </div>
                                    </div>
                                </form>
                                <!--/ form -->
        ...
        success: function(data) {
            if (data == "bos-deger") {
                ...
                return true;
                  ...
                  Swal.fire({
                    title: '<?php echo $bloklar["ayar_basarisiz_titlexyz"]; ?>',
                    text: '<?php echo $bloklar["ayar_basarisiz_descxyz"]; ?>',
                    icon: 'eror',
                    customClass: {
