                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" disabled   value="<?php echo $salonadi["kategori_adi"]; ?>" />
                                </div>
                            </div>
                            <div class="col-xl-6 col-md-6 col-12">
                                <div class="mb-1">
                    ...
                    <table id="example" class="dt-responsive table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $catRow["qr_musteri_name"];  ;?></td>
                                <td><?php echo $catRow["qr_musteri_telno"];  ;?></td>
                                <td><?php echo $catRow["qr_musteri_tc"].' '.$catRow["qr_salon"];  ;?></td>
                                <td>
 <?php 
                                                        if($catRow["qr_okuyucu"] == "on"){
                                                     if($catRow["bilet_durum"] == 1){
                                                ...
                                                <div class="chip-body">
                                                    <div class="chip-text">Onaylandı </div>
                                                </div>
                                            </div>
                                                        <?php
                                                    }
                                ...
                                <td>
                                    <button onclick="window.open('<?php echo URL.NFTBILET.$catRow['qr_random']."/".$catRow['qr_product'] ?>')" class="btn btn-primary  me-1 mt-2"><?php echo $bloklar["table_seven"]; ?></button>
                                    </center>
